...
import { getMovies, getMoviesByCategory, getFeaturedMovie } from "@/lib/movies"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="space-y-12 pb-12 -mt-32 relative z-20">
        {categories.map((category) => (
          <MovieRow key={category.key} title={t(`category.${category.key}`)} movies={category.movies} />
        ))}
      </div>
    </div>
  )
